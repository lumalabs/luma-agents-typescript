import fs from 'fs';
import type { ResponseLike } from 'luma-agents/internal/to-file';
import { toFile } from 'luma-agents/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('luma-agents/core/uploads');
    await expect(
