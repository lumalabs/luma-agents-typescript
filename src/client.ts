...
import { Generation, GenerationCreateParams, GenerationFailureCode, GenerationOutput, Generations } from './resources/generations';
...
export class Luma {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      authToken,
      ...opts,
      baseURL: baseURL || `https://agents.lumalabs.ai/v1`,
    };
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('LUMA_LOG'), 'process.env[\'LUMA_LOG\']', this) ?? defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://agents.lumalabs.ai/v1';
  }
